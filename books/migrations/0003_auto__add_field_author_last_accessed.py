...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('books_author', 'last_accessed', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 3, 9, 15, 51, 35, 516854), null=True, blank=True), keep_default=False)
    ...
    models = {
        'books.author': {
            ...
            'last_accessed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 3, 9, 15, 51, 35, 516854)', 'null': 'True', 'blank': 'True'}),
